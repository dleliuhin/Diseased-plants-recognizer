...
if(i <= (length(f(:))/2))        
    h_R_Contrast1(end+1) = stats_R.Contrast(1);
    h_R_Correlation1(end+1) = stats_R.Correlation(1);
    h_R_Energy1(end+1) = stats_R.Energy(1);
    h_R_Homogeneity1(end+1) = stats_R.Homogeneity(1); 
    
    h_G_Contrast1(end+1) = stats_G.Contrast(1);
    h_G_Correlation1(end+1) = stats_G.Correlation(1);
    h_G_Energy1(end+1) = stats_G.Energy(1);
    h_G_Homogeneity1(end+1) = stats_G.Homogeneity(1);    
    
    h_B_Contrast1(end+1) = stats_G.Contrast(1);
    h_B_Correlation1(end+1) = stats_G.Correlation(1);
    h_B_Energy1(end+1) = stats_G.Energy(1);
    h_B_Homogeneity1(end+1) = stats_G.Homogeneity(1);    
    
    h_RG_Contrast1(end+1) = stats_RG.Contrast(1);
    h_RG_Correlation1(end+1) = stats_RG.Correlation(1);
    h_RG_Energy1(end+1) = stats_RG.Energy(1);
    h_RG_Homogeneity1(end+1) = stats_RG.Homogeneity(1);    
    
    h_RB_Contrast1(end+1) = stats_RB.Contrast(1);
    h_RB_Correlation1(end+1) = stats_RB.Correlation(1);
    h_RB_Energy1(end+1) = stats_RB.Energy(1);
    h_RB_Homogeneity1(end+1) = stats_RB.Homogeneity(1);
    
    h_GB_Contrast1(end+1) = stats_GB.Contrast(1);
    h_GB_Correlation1(end+1) = stats_GB.Correlation(1);
    h_GB_Energy1(end+1) = stats_GB.Energy(1);
    h_GB_Homogeneity1(end+1) = stats_GB.Homogeneity(1);    
else
    nh_R_Contrast1(end+1) = stats_R.Contrast(1);
    nh_R_Correlation1(end+1) = stats_R.Correlation(1);
    nh_R_Energy1(end+1) = stats_R.Energy(1);
    nh_R_Homogeneity1(end+1) = stats_R.Homogeneity(1);
    
    nh_G_Contrast1(end+1) = stats_G.Contrast(1);
    nh_G_Correlation1(end+1) = stats_G.Correlation(1);
    nh_G_Energy1(end+1) = stats_G.Energy(1);
    nh_G_Homogeneity1(end+1) = stats_G.Homogeneity(1);    
    
    nh_B_Contrast1(end+1) = stats_B.Contrast(1);
    nh_B_Correlation1(end+1) = stats_B.Correlation(1);
    nh_B_Energy1(end+1) = stats_B.Energy(1);
    nh_B_Homogeneity1(end+1) = stats_B.Homogeneity(1);    
    
    nh_RG_Contrast1(end+1) = stats_RG.Contrast(1);
    nh_RG_Correlation1(end+1) = stats_RG.Correlation(1);
    nh_RG_Energy1(end+1) = stats_RG.Energy(1);
    nh_RG_Homogeneity1(end+1) = stats_RG.Homogeneity(1);    
    
    nh_RB_Contrast1(end+1) = stats_RB.Contrast(1);
    nh_RB_Correlation1(end+1) = stats_RB.Correlation(1);
    nh_RB_Energy1(end+1) = stats_RB.Energy(1);
    nh_RB_Homogeneity1(end+1) = stats_RB.Homogeneity(1);
    
    nh_GB_Contrast1(end+1) = stats_GB.Contrast(1);
    nh_GB_Correlation1(end+1) = stats_GB.Correlation(1);
    nh_GB_Energy1(end+1) = stats_GB.Energy(1);
    nh_GB_Homogeneity1(end+1) = stats_GB.Homogeneity(1);        
end
